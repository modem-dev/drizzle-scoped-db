...
- Generalize positioning beyond multi-tenancy: present scoping as a guardrail for any required query predicate (org, user, region, soft-delete) and add a "Beyond tenancy" README section.
